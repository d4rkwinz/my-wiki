...
- [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) — Claude Code skill pack for an academic-research pipeline (research → write → review → revise → finalize); covers literature review, peer review, and prompt engineering tuned for academic writing. Domain-specific cousin to [wanshuiyin/Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) (ML research) and [mattpocock/skills](https://github.com/mattpocock/skills) (general SWE). #python #claude-code #skills #ai #academic-writing
